...
class _DemoPageState extends State<DemoPage> {
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          ...
          children: [
            ...
            else if (isMultiScan && showMultiResult && multiResult != null && multiResult!.codes.isNotEmpty)
              MultiScanResultWidget(
                  ...
                  if (showDebugInfo)
                    DebugInfoWidget(
                      ...
                      duration: isMultiScan
                          ...
                          : result?.duration ?? 0,
                      onReset: _onReset,
                      onViewResults: isMultiScan ? () => setState(() => showMultiResult = true) : null,
  ...
  void _onMultiScanFailure(Codes result) {
    setState(() {
      failedScans++;
      // Don't replace accumulated results on failure
    });
